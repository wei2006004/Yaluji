...
public class RoadUtils {
    ...
    public static Pair<Integer, Integer> getRoadGrid(double roadWidth, double roadLength, double rollerWidth) {
        return getRoadGrid(roadWidth, roadLength, rollerWidth, DEFAULT_STEP);
    }

    public static Pair<Integer, Integer> getRoadGrid(double roadWidth, double roadLength, double rollerWidth, double step) {
