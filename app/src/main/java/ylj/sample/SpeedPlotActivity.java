...
public class SpeedPlotActivity extends Activity {
	
	public final static String TAG ="SpeedPlotActivity";
	...
	private void drawPlot()
	{
		...
		for (DrawData.PlotData data : dataList) {
			tempEdit.addPoint(new PointF((float)data.runtime, data.speed));
		}
		tempEdit.commit();
	}
...
//		getMenuInflater().inflate(R.menu.speed_plot, menu);
//		return true;
//	}
//
//	@Override
