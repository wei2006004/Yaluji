...
public class QuakePlotActivity extends Activity {
	
	public final static String TAG ="QuakePlotActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_quake_plot);
	...
	private void drawPlot()
	{
		...
		for (DrawData.PlotData data : dataList) {
			tempEdit.addPoint(new PointF((float)data.runtime, data.quake));
		}
		tempEdit.commit();
	}
